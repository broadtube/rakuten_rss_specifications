...
### Excel ワークシート関数
```excel
RssStockOrder(発注ID, 発注トリガー, 銘柄コード, 売買区分, 注文区分, SOR区分, 注文数量, 価格区分, 注文価格, 執行条件, 注文期間, 口座区分, 逆指値条件価格, 逆指値条件区分, 逆指値価格区分, 逆指値価格, セット注文区分, セット注文価格, セット注文執行条件, セット注文期間)
```

### VBA関数
```vb
RssStockOrder_V(発注ID, 銘柄コード, 売買区分, 注文区分, SOR区分, 注文数量, 価格区分, 注文価格, 執行条件, 注文期間, 口座区分, 逆指値条件価格, 逆指値条件区分, 逆指値価格区分, 逆指値価格, セット注文区分, セット注文価格, セット注文執行条件, セット注文期間)
```
...
| 8 | 価格区分 | ● | ● | - | number | 0:成行, 1:指値（逆指値注文時は不要） |
| 9 | 注文価格 | △ | △ | - | number | 指値の場合の価格 |
| 10 | 執行条件 | ● | ● | ● | number | 1:本日中, 2:今週中, 3:寄付, 4:引け, 5:期間指定, 6:大引不成, 7:不成 |
| 11 | 注文期間 | △ | △ | △ | string | 期間指定時のYYYYMMDD形式日付 |
| 12 | 口座区分 | ● | ● | ● | number | 0:特定, 1:一般, 2:NISA, 3:旧NISA |
| 13 | 逆指値条件価格 | - | ● | ● | number | 逆指値の条件価格 |
| 14 | 逆指値条件区分 | - | ● | ● | number | 1:以下, 2:以上 |
| 15 | 逆指値価格区分 | - | ● | ● | number | 0:成行, 1:指値 |
| 16 | 逆指値価格 | - | ● | ● | number | 逆指値の価格 |
| 17 | セット注文区分 | △ | △ | △ | number | 0:通常, 1:セット注文 |
| 18 | セット注文価格 | △ | △ | △ | number | セット注文の価格 |
| 19 | セット注文執行条件 | △ | △ | △ | number | セット注文の執行条件 |
| 20 | セット注文期間 | △ | △ | △ | string | セット注文の期日 |
