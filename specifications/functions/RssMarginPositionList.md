...
```excel
RssMarginPositionList(ヘッダー行, 銘柄コード, 口座区分, 信用区分, 売買, 直近決済返済日)
```
...
| 6 | 直近決済返済日 | number | 任意 | **0 or 省略**: 全て<br>**1**: 当日<br>**2**: 1週間以内<br>**3**: 1ヶ月以内<br>**4**: 3ヶ月以内<br>**5**: 3ヶ月超 |
